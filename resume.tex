...
\address{Charlotte, NC \\  (704) 657-8550 \\ asgentile@gmail.com}
...
\section{EXPERIENCE}
   ...
   \hspace{2.3in}\= \hspace{2.6in}\= \kill % set up two tab positions
    {\bf Senior Engineer} \>Follow Up Boss     \> February 2014 - Present\\
                             \>San Francisco, CA (Remote)
   \end{tabbing}\vspace{-5pt}      % suppress blank line after tabbing
   \begin{itemize}
    \item Scrum Master for agile development team.
    \item Implemented large scale email processing service which to date has processed over 130M emails.
    \item Architecting and implementing new features and versions of the product.
    \item Helping choose key technologies for the future of the product.
    \item Interviewing new developer candidates.
...
\section{TECHNICAL KEYWORDS}
    ...
    HTML5, XHTML, CSS3, LESS, Sass, React, Backbone, jQuery \\
    PHP, Python, JavaScript \\
    PostgreSQL, MySQL, Redis, Memcached, SQL Server, SQLite, MongoDB, RabbitMQ \\
    Amazon Web Services, UNIX, Apache, IIS, SSH, Nagios, StatsD, Monit, Solr, Sphinx, Varnish \\
